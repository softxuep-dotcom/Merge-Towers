...
// 地面路径（对齐 assets/maps/forest-grid-bg.png 的 2×5 紧凑塔位版石板路）
const PATH_PTS = [
  { x: 108, y: -46 }, { x: 128, y: 105 }, { x: 145, y: 225 }, { x: 185, y: 312 },
  { x: 540, y: 312 }, { x: 625, y: 360 }, { x: 642, y: 500 }, { x: 628, y: 570 },
  { x: 575, y: 625 }, { x: 145, y: 625 }, { x: 92, y: 695 }, { x: 92, y: 800 },
  { x: 150, y: 850 }, { x: 550, y: 850 }, { x: 630, y: 905 }, { x: 605, y: 965 },
  { x: 515, y: 1008 }, { x: 455, y: 1030 },
];
// 飞行兵直线航道（GDD §4.2：穿过中央塔位射程）
const FLY_PTS = [{ x: -50, y: 390 }, { x: 500, y: 1015 }];
